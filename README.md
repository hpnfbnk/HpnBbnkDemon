...
Java Demon 모듈 : 주기적으로 반복 동작해 송수신을 자동으로 하는 독립적인 데몬형태모듈 및 업무관련자료입니다.
...
## 설치
[HpnBbnkDemon-1.6.3.zip](https://hpnfbnk.github.io/HpnBbnkDemon/HpnBbnkDemon-1.6.3.zip) 또는 
[HpnBbnkDemon-1.6.3.tar.gz](https://hpnfbnk.github.io/HpnBbnkDemon/HpnBbnkDemon-1.6.3.tar.gz) 을 다운받아 압축해제하면 됩니다.
...
## DB 연계
법인카드사용내역(C01~C07)의 경우 준비된 TABLE에 INSERT시킬수도 있습니다.
