...
@set CLASSPATH=%INSTALL_HOME%;%INSTALL_HOME%\HpnBbnkDemon-1.5.1-jar-with-dependencies.jar
@rem DB연계사용시 아래 start classpath 사용
@rem @set JDBC_PATH=%INSTALL_HOME%\mysql-connector-java-5.1.6-bin.jar
@rem @set CLASSPATH=%INSTALL_HOME%;%INSTALL_HOME%\HpnBbnkDemon-1.5.1-jar-with-dependencies.jar;%JDBC_PATH%
