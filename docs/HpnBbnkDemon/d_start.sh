...
#nohup $JAVA_HOME/bin/java -D$PROC_NAME -cp $INSTALL_HOME/HpnBbnkDemon-1.1.0-jar-with-dependencies.jar:$JDBC_PATH com.hyphen.fbnk.bbnkdemon.HpnBbnkDemon 1>/dev/null 2>$INSTALL_HOME/log/err.log &
